        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.CharField(
                    max_length=255, verbose_name='Document')),
                ('document_type', models.CharField(choices=[
                 ('CPF', 'CPF'), ('CNPJ', 'CNPJ')], max_length=10, verbose_name='Document type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('centroid', django.contrib.gis.db.models.fields.PointField(
                    blank=True, null=True, srid=4326, verbose_name='Centroid')),
                ('creation_date', models.DateTimeField(
                    auto_now_add=True, verbose_name='Creation date')),
                ('last_modification_date', models.DateTimeField(
                    auto_now=True, verbose_name='Last modification date')),
                ...
                ('municipality', models.CharField(
                    max_length=255, verbose_name='Municipality')),
                ('state', models.CharField(max_length=255, verbose_name='State')),
                ('owner', models.ForeignKey(on_delete=models.CASCADE,
                 to='farm_base.Owner', verbose_name='Owner')),
            ],
            options={
                'verbose_name': 'Farm',
